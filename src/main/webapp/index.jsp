			...
			if(session.getAttribute("role")!=null){
				if(session.getAttribute("role").equals("user")){
					...
					%>
						...
						<li class="navbar-item">
                                <a href="pages/user/myCourses.jsp" class="navbar-link" data-nav-link>My Courses</a>
                        </li>
			...
			if(session.getAttribute("role")!=null){
				if(session.getAttribute("role").equals("user")){
					...
					<span><%=session.getAttribute("name") %></span>
						<a href="pages/action.jsp?btn=logout" class="btn has-before">
					...
					%>
						<a href="./pages/signup.jsp" class="btn has-before">
        					  <span class="span">Sign up</span>
      					  </a>
				        <a href="./pages/login.jsp" class="btn has-before">
      ...
      <section class="section hero has-bg-image" id="home" aria-label="home"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <a href="./pages/allCourses.jsp" class="btn has-before">
