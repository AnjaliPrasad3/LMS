...
<% List<UserModel> list = UserDaw.getPurchasedCourses(); %>
  ...
  <section class="section course" id="courses" aria-label="course">
    <div class="container">
      ...
      <p class="section-subtitle">Your Courses</p>
      <h2 class="h2 section-title">Let's continue learning <%=session.getAttribute("name") %>...</h2>
        ...
        <li>
          <div class="course-card">
            ...
            <div class="card-content">
              ...
              <h3 class="h3">
                <a href="course.jsp?id=<%=u.getCourseId() %>" class="card-title"><%=u.getName() %></a>
              </h3>
      ...
      <a href="../allCourses.jsp" class="btn has-before">
