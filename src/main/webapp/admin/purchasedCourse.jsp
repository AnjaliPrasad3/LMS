...
<body>
<% List<UserModel> list = UserDaw.getPurchasedCourses(); %>
    <!-- Header -->
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="card">
                            <div class="card-header">
                                <span><i class="bi bi-table me-2"></i></span> Purchased Courses Table
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="table table-striped data-table" style="width: 100%">
                                        ...
                                        <% int i=0; for(UserModel u : list) { i++; %>
                                            <tr>
                                                ...
                                                <td><%=u.getEndDate() %></td>
                                                <td>
                                                <a href="edit.jsp?id=" class="btn btn-sm btn-success m-1" style="padding: 4px 8px;">Edit</a>
                                                  <a href="../pages/action.jsp?id=&btn=deleteregistration" class="btn btn-sm btn-danger m-1" style="padding: 4px 8px;">Delete</a>                                            
                                                </td>
                                            </tr>
                                            <% } %>
                                        </tbody>
