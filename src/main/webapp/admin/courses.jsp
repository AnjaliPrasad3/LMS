      ...
      <div class="container-fluid">
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        ...
                        <form
                          ...
                          method="post" action="./actionto.jsp" enctype="multipart/form-data"
                        >
                          <div class="mb-3">
                            <label for="email_field" class="form-label">Course Name</label>
                            <input
                              type="text"
                              id="name_field"
                          ...
                          <div class="mb-3">
                            <label for="email_field" class="form-label">Course Duration(in weeks)</label>
                            <input
                              type="number"
                              id="name_field"
                              class="form-control form-control-lg"
                          ...
                          <div class="mb-3">
                            <label for="email_field" class="form-label">Course Level</label>
                            <input
                              type="text"
                              id="name_field"
                              class="form-control form-control-lg"
                          ...
                          <div class="mb-3">
                            <label for="password_field" class="form-label">Description</label>
                            <input
                              type="text"
                              id="name_field"
                              class="form-control form-control-lg"
                          ...
                          <div class="mb-3">
                            <label for="password_field" class="form-label">Instructor</label>
                            <input
                              type="text"
                              id="name_field"
                              class="form-control form-control-lg"
                          ...
                          <div class="mb-3">
                            <label for="password_field" class="form-label">Rating</label>
                            <input
                              type="number"
                              id="name_field"
                              class="form-control form-control-lg"
                          ...
                          <div class="mb-3">
                            <label for="password_field" class="form-label">Image</label>
                            <input
                              type="file"
                              id="password_field"
                              class="form-control form-control-lg"
                              name="img"
                              accept=".jpg,.jpeg,.jfif,.pjpeg,.pjp,.webp"
                            />
                          </div>
                          <div class="mb-3">
                            <label for="password_field" class="form-label">Amount</label>
                            <input
                              type="number"
                              id="password_field"
                              class="form-control form-control-lg"
                          ...
                          <button style="width: 100%;" type="submit" class="btn has-before" name="btnCourse" value="addCourse">
                            Submit
                          </button>
                        </form>
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
            <div class="card">
              <div class="card-header">
                <span><i class="bi bi-table me-2"></i></span> All Courses Table
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table id="example" class="table table-striped data-table" style="width: 100%">
                    ...
                    <td><%=u.getLevel() %></td>
                    <td><%=u.getDesc() %></td>
                    <td><%=u.getInstructor() %></td>
                    <td><%=u.getRating()%></td>
                    <td><%=u.getImg() %></td>
                    <td><%=u.getAmount() %></td>
                    <td>
                    <a href="cEdit.jsp?id=<%=u.getId() %>" class="btn btn-sm btn-success m-1" style="padding: 4px 8px;">Edit</a>
