                                ...
                                <div class="table-responsive">
                                    ...
                                    <input type="hidden" name="id" value="<%=u.getId() %>">
                                        <div class="mb-3">
                                          ...
                                          <input type="text" id="name_field" class="form-control form-control-lg" name="name" value="<%=u.getName() %>" />
                                      </div>
                                        <div class="mb-3">
                                            <label for="email_field" class="form-label">Email</label>
                                            <input type="email" id="email_field" class="form-control form-control-lg" name="email" value="<%=u.getEmail() %>" />
                                        </div>
                            
                                        <div class="mb-3">
                                            <label for="password_field" class="form-label">Password</label>
                                            <input type="password" id="password_field" class="form-control form-control-lg" name="password" value="<%=u.getPassword() %>" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="password_field" class="form-label">Role</label>
                                            <input type="text" id="password_field" class="form-control form-control-lg" name="role" value="<%=u.getRole() %>" />
                                        </div>
                            
                                        <button style="width: 100%;" type="submit" class="btn has-before justify-content-center" name="btn" value="updateregistration">
                                            Edit
                                        </button>
                                    </form>
                                </div>
