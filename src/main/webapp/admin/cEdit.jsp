                    ...
                    <div class="col-md-12 mb-3">
                        <div class="card">
                            <div class="card-header">
                                <span><i class="bi bi-table me-2"></i></span> Edit Form
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form  method="post" action="../pages/action.jsp">
                          ...
                          <div class="mb-3">
                            ...
                            />
                                        ...
                                        <button style="width: 100%;" type="submit" class="btn has-before justify-content-center" name="btn" value="updatecourse">
                                            Edit
                                        </button>
                                    </form>
                                </div>
